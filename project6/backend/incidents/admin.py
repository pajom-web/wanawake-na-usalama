...
class PoliceOfficerAdminForm(forms.ModelForm):
    username = forms.CharField(
        max_length=150,
        help_text="Username the officer will enter in the Flutter login form.",
    )
...
class IncidentAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "severity", "category", "source", "created_at")
    search_fields = (
        "anonymous_token",
        "description",
        "reporter_phone",
...
class HotspotAdmin(admin.ModelAdmin):
    ...
    list_filter = ("risk_level", "source", "active", "created_at")
